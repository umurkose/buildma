/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings` (hash: 6a6267276298ca202034eb41e1a26ef1)
// Runtime types generated with workerd@1.20260702.1 2026-06-23 
interface __BaseEnv_CloudflareBindings {
	...
	JWT_SECRET: string;
	PLATO_API_URL: string;
	PLATO_API_KEY: string;
	PLATO_WEBHOOK_SECRET: string;
	PLATO_FLOW_ID: string;
	PLATO_RETURN_URL: string;
}
